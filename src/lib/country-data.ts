...
export const COUNTRY_GUIDES: Record<string, CountryGuide> = {
  ...
  pt: {
    ...
    currency: 'EUR',
    language: 'Portuguese',
    specialPrograms: ['NHR (Non-Habitual Resident)', 'D7 Visa', 'Digital Nomad Visa'],
    lastUpdated: '2024-12-01',
  },
  th: {
    code: 'TH',
...
export const COUNTRY_TAX_INFO: Record<string, CountryTaxInfo> = {
  us: {
    ...
    taxRates: [
      { type: 'Income Tax', rate: '10% - 37%', description: 'Progressive federal tax brackets' },
      { type: 'Self-Employment', rate: '15.3%', description: 'Social Security and Medicare taxes' },
      { type: 'Capital Gains', rate: '0% - 20%', description: 'Long-term capital gains rates' },
      { type: 'State Tax', rate: '0% - 13.3%', description: 'Varies by state' },
    ],
    specialPrograms: [
      {
        name: 'Foreign Earned Income Exclusion (FEIE)',
        description: 'Exclude up to $126,500 (2024) of foreign earned income from US tax',
        eligibility: [
    ...
    doubleTaxationTreaties: [
      'UK', 'Germany', 'France', 'Canada', 'Japan', 'Australia', 'Netherlands',
      'Switzerland', 'Spain', 'Italy', 'Portugal', 'Thailand',
    ],
    remoteWorkRules: [
    ...
    faqs: [
      {
        ...
        answer: 'Yes, US citizens and green card holders must file US taxes regardless of where they live, if their income exceeds filing thresholds.',
      },
      {
        question: 'Can I use both FEIE and Foreign Tax Credit?',
        answer: 'You can use both, but not on the same income. The Foreign Tax Credit is typically used for income above the FEIE limit or for passive income.',
      },
      {
        question: 'What is the Substantial Presence Test?',
        answer: 'A formula to determine tax residency: be present 31+ days in current year AND have 183+ days when counting current year fully, prior year at 1/3, and second prior year at 1/6.',
      },
    ],
  },
  gb: {
    ...
    taxRates: [
      { type: 'Income Tax', rate: '20% - 45%', description: 'Basic (20%), Higher (40%), Additional (45%)' },
      { type: 'National Insurance', rate: '12% / 2%', description: 'Employee contributions' },
      { type: 'Capital Gains', rate: '10% - 20%', description: 'Basic rate 10%, Higher rate 20%' },
      { type: 'Dividend Tax', rate: '8.75% - 39.35%', description: 'Depends on income band' },
    ],
    specialPrograms: [
      {
        name: 'Non-Domiciled Status',
        description: 'UK residents not domiciled in UK can use remittance basis of taxation',
        eligibility: [
      ...
      },
      {
        ...
        description: 'Reduce UK tax on employment income for non-domiciled individuals',
        eligibility: [
          'Non-UK domiciled',
    ...
    doubleTaxationTreaties: [
      'USA', 'Germany', 'France', 'Spain', 'Portugal', 'Italy', 'Australia',
      'Canada', 'Singapore', 'Hong Kong', 'Thailand', 'UAE',
    ],
    remoteWorkRules: [
    ...
    faqs: [
      {
        ...
        answer: 'The SRT is a series of tests that determine UK tax residency based on days spent in the UK, connections to the UK, and work patterns.',
      },
      {
        question: 'How many days can I spend in the UK without becoming resident?',
        answer: 'It depends on your ties to the UK. With no ties, up to 182 days. With many ties, as few as 16-45 days could trigger residency.',
      },
    ],
  },
  de: {
    ...
    taxRates: [
      { type: 'Income Tax', rate: '14% - 45%', description: 'Progressive rates with solidarity surcharge' },
      { type: 'Solidarity Surcharge', rate: '5.5%', description: 'On income tax for high earners' },
      { type: 'Church Tax', rate: '8-9%', description: 'On income tax if member of recognized church' },
      { type: 'Trade Tax', rate: '7% - 17%', description: 'For business income, varies by municipality' },
    ],
    specialPrograms: [
      {
        name: 'Freelancer Visa (Freiberufler)',
        description: 'Visa for self-employed professionals in liberal professions',
        eligibility: [
    ...
    doubleTaxationTreaties: [
      'USA', 'UK', 'France', 'Spain', 'Portugal', 'Italy', 'Netherlands',
      'Switzerland', 'Austria', 'Thailand', 'Singapore', 'Australia',
    ],
    remoteWorkRules: [
    ...
    faqs: [
      {
        ...
        answer: 'If you stay more than 3 months and have a fixed address, you must register. This registration can establish tax residency.',
      },
      {
        question: 'What is the difference between Freiberufler and Gewerbe?',
        answer: 'Freiberufler are liberal professionals (consultants, artists, etc.) with simpler tax treatment. Gewerbe is commercial business subject to trade tax.',
      },
    ],
  },
  pt: {
    ...
    taxRates: [
      { type: 'Income Tax', rate: '14.5% - 48%', description: 'Progressive rates for residents' },
      { type: 'NHR Rate', rate: '20%', description: 'Flat rate for qualifying employment income' },
      { type: 'Capital Gains', rate: '28%', description: 'Standard rate, 50% exemption available' },
      { type: 'Social Security', rate: '11%', description: 'Employee contribution' },
    ],
    specialPrograms: [
      {
        name: 'Non-Habitual Resident (NHR)',
        description: '10-year tax regime with favorable rates for new residents',
        eligibility: [
      ...
      },
      {
        ...
        description: 'Visa for those with passive income (retirement, investments)',
        eligibility: [
    ...
    doubleTaxationTreaties: [
      'USA', 'UK', 'Germany', 'France', 'Spain', 'Brazil', 'Netherlands',
      'Switzerland', 'Canada', 'Australia', 'Thailand',
    ],
    remoteWorkRules: [
    ...
    faqs: [
      {
        ...
        answer: 'The NHR regime has been modified. New applicants from 2024 may face different rules. Check current legislation for the latest requirements.',
      },
      {
        question: 'Can I work remotely on the D7 visa?',
        answer: 'Yes, the D7 visa allows remote work for foreign employers, though its primary purpose is for passive income recipients.',
      },
    ],
  },
  th: {
    ...
    taxRates: [
      { type: 'Income Tax', rate: '0% - 35%', description: 'Progressive rates, first 150k THB exempt' },
      { type: 'Capital Gains', rate: '0% - 35%', description: 'Included in income tax' },
      { type: 'Withholding Tax', rate: '10% - 15%', description: 'On various payment types' },
      { type: 'Social Security', rate: '5%', description: 'Capped at 750 THB/month' },
    ],
    specialPrograms: [
      {
    ...
    doubleTaxationTreaties: [
      'USA', 'UK', 'Germany', 'France', 'Japan', 'Australia', 'Singapore',
      'Hong Kong', 'Malaysia', 'Vietnam', 'China',
    ],
    remoteWorkRules: [
    ...
    faqs: [
      {
        ...
        answer: 'From 2024, foreign income remitted to Thailand in the same year it was earned is taxable. Previously, only income remitted in a subsequent year was taxable. The LTR visa provides an exemption from this rule.',
      },
      {
        question: 'Can digital nomads work legally in Thailand?',
        answer: 'Technically, working in Thailand requires a work permit. The LTR visa includes a digital work permit. The Thailand Elite visa does not include work permission.',
      },
    ],
  },
}
