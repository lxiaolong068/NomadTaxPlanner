...
export const metadata: Metadata = {
    title: "Tax Residency Explained: Where Do You Actually Owe Taxes? | NomadTaxPlanner",
    description:
...
export default function TaxResidencyPage() {
    return (
        ...
        >
            ...
            <ul>
                <li><strong>The Rule:</strong> If you spend more than X days in the country, you are a resident.</li>
                <li><strong>Common Threshold:</strong> 183 days is the standard (UK, Canada, Australia, most of EU).</li>
                <li><strong>Exceptions:</strong> Some countries have shorter periods (e.g., Cyprus is 60 days under certain conditions; Switzerland can be 90 days if you work).</li>
            </ul>
            ...
            <ul>
                ...
                <li>Where your permanent home is available (owned or rented long-term).</li>
                <li>Where your economic interests are (bank accounts, investments, main business).</li>
                <li>Where you belong to social clubs or have health insurance.</li>
            </ul>
            <p>
                <em>Example:</em> You spend 100 days in Spain, but your wife and kids live there, and you own a house there. Spain will likely consider you a tax resident.
            </p>
            ...
            <p>
                In this case, <strong>Double Taxation Treaties</strong> come into play. These treaties have &quot;tie-breaker&quot; rules to decide which country claims you as a resident. Usually, it goes in this order:
            </p>
            <ol>
            ...
            <p>
                Don&apos;t guess. Use our free <a href="/tools/tax-residency-checker">Tax Residency Checker</a> to get a preliminary assessment of your situation based on your travel patterns.
            </p>
        </ArticleLayout>
    );
}
