  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-b from-primary/5 to-background py-20 md:py-32 overflow-hidden">
        ...
        <img
          src="https://oxnbbm6ljoyuzqns.public.blob.vercel-storage.com/studying-books-laptop-education-learning/qPl8Qy8NPyY.jpg"
      ...
      <section className="py-20 bg-muted/50">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-4">Stay Updated on Tax Laws</h2>
